...
<body class="g-sidenav-show  bg-gray-100">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="index?parametre=Accounts">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-users i-color"></i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="index?parametre=Sections">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-building i-color"></i>
            </div>
            <span class="nav-link-text ms-1">Bölümler</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../pages/profile.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-user i-color"></i>
            </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg min-height-vh-100 ">
    <!-- Navbar -->
